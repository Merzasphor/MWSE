	...
	namespace lua {
		namespace event {
			void DisableableEventManager::bindToLua() {
				...
				usertypeDefinition.set("addSound", sol::property(&AddSoundEvent::getEventEnabled, &AddSoundEvent::setEventEnabled));
				usertypeDefinition.set("addTempSound", sol::property(&AddTempSoundEvent::getEventEnabled, &AddTempSoundEvent::setEventEnabled));
				...
				usertypeDefinition.set("postInfoResponse", sol::property(&PostInfoResponseEvent::getEventEnabled, &PostInfoResponseEvent::setEventEnabled));
				usertypeDefinition.set("potionBrewed", sol::property(&PotionBrewedEvent::getEventEnabled, &PotionBrewedEvent::setEventEnabled));
				usertypeDefinition.set("preLevelUp", sol::property(&PreLevelUpEvent::getEventEnabled, &PreLevelUpEvent::setEventEnabled));
				...
				usertypeDefinition.set("soundObjectPlay", sol::property(&SoundObjectPlayEvent::getEventEnabled, &SoundObjectPlayEvent::setEventEnabled));
