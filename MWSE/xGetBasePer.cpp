/************************************************************************
	...
	xGetBasePer.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	class xGetBasePer : mwse::InstructionInterface_t
	{
	public:
		xGetBasePer();
	...
	static const mwse::mwOpcode_t xGetBasePerOpcode = 0x3F37;
	static xGetBasePer xGetBasePerInstance;

	xGetBasePer::xGetBasePer() : mwse::InstructionInterface_t(xGetBasePerOpcode) {}

	void xGetBasePer::loadParameters(mwse::VMExecuteInterface &virtualMachine) {}
	...
	float xGetBasePer::execute(mwse::VMExecuteInterface &virtualMachine)
	{
		...
		mwse::Stack::getInstance().pushFloat(macp->attributes[Personality].base);
