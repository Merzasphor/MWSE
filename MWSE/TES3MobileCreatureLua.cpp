...
namespace mwse {
	namespace lua {
		void bindTES3MobileCreature() {
			...
			usertypeDefinition.set("runSpeed", sol::readonly_property(&TES3::MobileCreature::calculateRunSpeed));
			usertypeDefinition.set("swimSpeed", sol::readonly_property(&TES3::MobileCreature::calculateSwimSpeed));
			usertypeDefinition.set("swimRunSpeed", sol::readonly_property(&TES3::MobileCreature::calculateSwimRunSpeed));
			usertypeDefinition.set("flySpeed", sol::readonly_property(&TES3::MobileCreature::calculateFlySpeed));
