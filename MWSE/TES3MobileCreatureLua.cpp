		...
		void bindTES3MobileCreature() {
			...
			state.new_usertype<TES3::MobileCreature>("TES3MobileCreature",
				...
				"activeAI", sol::property(
					[](TES3::MobileCreature& self) { return self.getMobileActorFlag(TES3::MobileActorFlag::ActiveAI); },
					[](TES3::MobileCreature& self, bool set) { self.setMobileActorFlag(TES3::MobileActorFlag::ActiveAI, set); }
					),
				"werewolf", sol::property([](TES3::MobileCreature& self) { return self.getMobileActorFlag(TES3::MobileActorFlag::Werewolf); }),
				"underwater", sol::property([](TES3::MobileCreature& self) { return self.getMobileActorFlag(TES3::MobileActorFlag::Underwater); }),
				"weaponDrawn", sol::property([](TES3::MobileCreature& self) { return self.getMobileActorFlag(TES3::MobileActorFlag::WeaponDrawn); }),
				"spellReadied", sol::property([](TES3::MobileCreature& self) { return self.getMobileActorFlag(TES3::MobileActorFlag::SpellReadied); }),
				"inCombat", sol::property([](TES3::MobileCreature& self) { return self.getMobileActorFlag(TES3::MobileActorFlag::InCombat); }),
				"attacked", sol::property([](TES3::MobileCreature& self) { return self.getMobileActorFlag(TES3::MobileActorFlag::Attacked); }),
				"isCrittable", sol::property([](TES3::MobileCreature& self) { return self.getMobileActorFlag(TES3::MobileActorFlag::IsCrittable); }),
				"idleAnim", sol::property([](TES3::MobileCreature& self) { return self.getMobileActorFlag(TES3::MobileActorFlag::IdleAnim); }),
