/************************************************************************
	...
	xGetBaseRestoration.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	class xGetBaseRestoration : mwse::InstructionInterface_t
	{
	public:
		xGetBaseRestoration();
	...
	float xGetBaseRestoration::execute(mwse::VMExecuteInterface &virtualMachine)
	{
		...
		mwse::Stack::getInstance().pushFloat(macp->skills[TES3::SkillRestoration].base);
