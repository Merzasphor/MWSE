...
namespace TES3 {
	const auto TES3_MobPlayerController_checkRadius = reinterpret_cast<void(__thiscall*)(MobPlayerController*, MobileActor*, Iterator<AIPlanner>*)>(0x5704B0);
	const auto TES3_MobPlayerController_detectPresence = reinterpret_cast<bool(__thiscall*)(MobPlayerController*, MobileActor*, bool)>(0x570A60);
	const auto TES3_MobPlayerController_detectSneak = reinterpret_cast<bool(__thiscall*)(MobPlayerController*, MobileActor*, MobileActor*, bool)>(0x570600);
	const auto TES3_MobPlayerController_checkPlayerDist = reinterpret_cast<void(__thiscall*)(MobPlayerController*)>(0x56F730);
	...
	bool MobPlayerController::detectPresence(MobileActor * actor, bool unknown) {
		return TES3_MobPlayerController_detectPresence(this, actor, unknown);
	}

	bool MobPlayerController::detectSneak(MobileActor* detector, MobileActor* target, bool unknown)
	{
		// Call the original function to get the default sneak detection.
		bool isDetected = TES3_MobPlayerController_detectSneak(this, detector, target, unknown);
	...
	void MobPlayerController::checkRadius(MobileActor * actor, Iterator<AIPlanner> * container) {
		TES3_MobPlayerController_checkRadius(this, actor, container);
	}

	void MobPlayerController::checkPlayerDistance() {
		TES3_MobPlayerController_checkPlayerDist(this);
	}
	...
	void MobController::checkPlayerDistance() {
		mobPlayerController->checkPlayerDistance();
	}
}
