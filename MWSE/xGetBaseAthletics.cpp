/************************************************************************
	...
	xGetBaseAthletics.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	class xGetBaseAthletics : mwse::InstructionInterface_t
	{
	public:
		xGetBaseAthletics();
	...
	float xGetBaseAthletics::execute(mwse::VMExecuteInterface &virtualMachine)
	{
		...
		mwse::Stack::getInstance().pushFloat(macp->skills[TES3::SkillAthletics].base);
