...
namespace mwse {
	namespace lua {
		...
		sol::object getReference(sol::optional<const char*> id) {
			if (id) {
		...
		sol::object getObject(const char* id) {
			TES3::DataHandler* dataHandler = TES3::DataHandler::get();
			if (dataHandler) {
		...
		sol::object getScript(const char* id) {
			TES3::DataHandler* dataHandler = TES3::DataHandler::get();
			if (dataHandler) {
		...
		sol::object findGlobal(std::string& id) {
			TES3::DataHandler* dataHandler = TES3::DataHandler::get();
			if (dataHandler) {
		...
		sol::object findGMST(sol::object key) {
			TES3::DataHandler* dataHandler = TES3::DataHandler::get();
		...
		sol::object getGMST(sol::object key) {
		...
		sol::object getSound(const char* id) {
			TES3::DataHandler* dataHandler = TES3::DataHandler::get();
			if (dataHandler) {
		...
		sol::object getSoundGenerator(std::string creatureId, unsigned int type) {
		...
		sol::object getFaction(const char* id) {
			TES3::DataHandler* dataHandler = TES3::DataHandler::get();
			if (dataHandler) {
		...
		sol::object getMagicEffect(int id) {
			TES3::DataHandler* dataHandler = TES3::DataHandler::get();
		...
		sol::object getSkill(int skillID) {
			TES3::DataHandler* dataHandler = TES3::DataHandler::get();
			if (dataHandler) {
		...
		sol::object loadMesh(const char* relativePath, sol::optional<bool> useCached) {
		...
		sol::object getDialogueInfo(sol::table params) {
		...
		sol::object getCell(sol::table params) {
		...
		sol::object createCell(sol::table params) {
			auto nonDynamicData = TES3::DataHandler::get()->nonDynamicData;
		...
		sol::object createReference(sol::table params) {
			auto dataHandler = TES3::DataHandler::get();
		...
		sol::object createObject(sol::table params) {
		...
		sol::object getMagicSourceInstanceBySerial(sol::table params) {
		...
		sol::object dropItem(sol::table params) {
			// Who is dropping?
		...
		sol::object addMagicEffect(sol::table params) {
