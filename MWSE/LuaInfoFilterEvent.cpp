...
namespace mwse {
	namespace lua {
		namespace event {
			InfoFilterEvent::InfoFilterEvent(TES3::DialogueInfo * info, TES3::Actor * actor, TES3::Reference * reference, signed char source, TES3::Dialogue * dialogue, bool passes) :
