	...
	namespace lua {
		void bindTES3MagicEffect() {
			...
			// Binding for TES3::MagicEffect
			{
				...
				usertypeDefinition.set("areaSoundEffect", sol::property(&TES3::MagicEffect::getAreaSoundEffect, &TES3::MagicEffect::setAreaSoundEffect));
				...
				usertypeDefinition.set("boltSoundEffect", sol::property(&TES3::MagicEffect::getBoltSoundEffect, &TES3::MagicEffect::setBoltSoundEffect));
				...
				usertypeDefinition.set("castSoundEffect", sol::property(&TES3::MagicEffect::getCastSoundEffect, &TES3::MagicEffect::setCastSoundEffect));
				...
				usertypeDefinition.set("hitSoundEffect", sol::property(&TES3::MagicEffect::getHitSoundEffect, &TES3::MagicEffect::setHitSoundEffect));
				...
				usertypeDefinition.set("icon", sol::property(&TES3::MagicEffect::getIcon, &TES3::MagicEffect::setIcon));
				usertypeDefinition.set("particleTexture", sol::property(&TES3::MagicEffect::getParticleTexture, &TES3::MagicEffect::setParticleTexture));
