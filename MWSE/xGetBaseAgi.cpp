/************************************************************************
	...
	xGetBaseAgi.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	...
	static const mwse::mwOpcode_t xGetBaseAgiOpcode = 0x3F34;
	static xGetBaseAgi xGetBaseAgiInstance;

	xGetBaseAgi::xGetBaseAgi() : mwse::InstructionInterface_t(xGetBaseAgiOpcode) {}
	...
	float xGetBaseAgi::execute(mwse::VMExecuteInterface &virtualMachine)
	{
		...
		mwse::Stack::getInstance().pushFloat(macp->attributes[Agility].base);
