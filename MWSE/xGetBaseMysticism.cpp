/************************************************************************
	...
	xGetBaseMysticism.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	class xGetBaseMysticism : mwse::InstructionInterface_t
	{
	public:
		xGetBaseMysticism();
	...
	float xGetBaseMysticism::execute(mwse::VMExecuteInterface &virtualMachine)
	{
		...
		mwse::Stack::getInstance().pushFloat(macp->skills[TES3::SkillMysticism].base);
