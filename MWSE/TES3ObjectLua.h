...
namespace mwse {
	namespace lua {
		template <typename T>
		void setUserdataForBaseObject(T& usertypeDefinition) {
		...
		template <typename T>
		void setUserdataForObject(T& usertypeDefinition) {
		...
		template <typename T>
		void setUserdataForPhysicalObject(T& usertypeDefinition) {
