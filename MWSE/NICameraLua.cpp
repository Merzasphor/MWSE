...
namespace mwse {
	namespace lua {
		void bindNICamera() {
			...
			usertypeDefinition["renderer"] = sol::readonly_property([](NI::Camera& self) { return self.renderer; });
			usertypeDefinition["scene"] = sol::readonly_property([](NI::Camera& self) { return self.scene; });
		}
	}
}
