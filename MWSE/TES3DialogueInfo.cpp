...
namespace TES3 {
	...
	const auto TES3_DialogueInfo_filter = reinterpret_cast<bool(__thiscall*)(DialogueInfo*, Object*, Reference*, signed char, Dialogue*)>(0x4B0190);
	...
	bool DialogueInfo::filter(Object * actor, Reference * reference, signed char source, Dialogue * dialogue) {
