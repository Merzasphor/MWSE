/************************************************************************
	...
	xGetBaseBluntWeapon.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	class xGetBaseBluntWeapon : mwse::InstructionInterface_t
	{
	public:
		xGetBaseBluntWeapon();
	...
	float xGetBaseBluntWeapon::execute(mwse::VMExecuteInterface &virtualMachine)
	{
		...
		mwse::Stack::getInstance().pushFloat(macp->skills[TES3::SkillBluntWeapon].base);
