/************************************************************************
	...
	xBitXor.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	...
	static const mwse::mwOpcode_t xBitXorOpcode = 0x3938;
	static xBitXor xBitXorInstance;

	xBitXor::xBitXor() : mwse::InstructionInterface_t(xBitXorOpcode) {}
