/************************************************************************
	...
	xGetBaseSpe.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	...
	static const mwse::mwOpcode_t xGetBaseSpeOpcode = 0x3F35;
	static xGetBaseSpe xGetBaseSpeInstance;

	xGetBaseSpe::xGetBaseSpe() : mwse::InstructionInterface_t(xGetBaseSpeOpcode) {}
	...
	float xGetBaseSpe::execute(mwse::VMExecuteInterface &virtualMachine)
	{
		...
		mwse::Stack::getInstance().pushFloat(macp->attributes[Speed].base);
