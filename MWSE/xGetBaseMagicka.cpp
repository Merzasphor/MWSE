/************************************************************************
	...
	xGetBaseMagicka.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	class xGetBaseMagicka : mwse::InstructionInterface_t
	{
	public:
		xGetBaseMagicka();
	...
	float xGetBaseMagicka::execute(mwse::VMExecuteInterface &virtualMachine)
	{
		...
		mwse::Stack::getInstance().pushFloat(macp->magicka.base);
