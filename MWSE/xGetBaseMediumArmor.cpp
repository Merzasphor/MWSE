/************************************************************************
	...
	xGetBaseMediumArmor.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	class xGetBaseMediumArmor : mwse::InstructionInterface_t
	{
	public:
		xGetBaseMediumArmor();
	...
	float xGetBaseMediumArmor::execute(mwse::VMExecuteInterface &virtualMachine)
	{
		...
		mwse::Stack::getInstance().pushFloat(mobileObject->skills[TES3::SkillID::MediumArmor].base);
