/************************************************************************
	...
	xGetBaseLightArmor.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	class xGetBaseLightArmor : mwse::InstructionInterface_t
	{
	public:
		xGetBaseLightArmor();
	...
	float xGetBaseLightArmor::execute(mwse::VMExecuteInterface &virtualMachine)
	{
		...
		mwse::Stack::getInstance().pushFloat(macp->skills[TES3::SkillLightArmor].base);
