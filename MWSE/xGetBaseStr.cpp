/************************************************************************
	...
	xGetBaseStr.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	...
	static const mwse::mwOpcode_t xGetBaseStrOpcode = 0x3F31;
	static xGetBaseStr xGetBaseStrInstance;

	xGetBaseStr::xGetBaseStr() : mwse::InstructionInterface_t(xGetBaseStrOpcode) {}
	...
	float xGetBaseStr::execute(mwse::VMExecuteInterface &virtualMachine)
	{
		...
		mwse::Stack::getInstance().pushFloat(macp->attributes[Strength].base);
