/************************************************************************
	...
	xGetBaseSpeechcraft.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	class xGetBaseSpeechcraft : mwse::InstructionInterface_t
	{
	public:
		xGetBaseSpeechcraft();
	...
	float xGetBaseSpeechcraft::execute(mwse::VMExecuteInterface &virtualMachine)
	{
		...
		mwse::Stack::getInstance().pushFloat(mobileObject->skills[TES3::SkillID::Speechcraft].base);
