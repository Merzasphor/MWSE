/************************************************************************
	...
	xGetBaseEnd.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	class xGetBaseEnd : mwse::InstructionInterface_t
	{
	public:
		xGetBaseEnd();
	...
	static const mwse::mwOpcode_t xGetBaseEndOpcode = 0x3F36;
	static xGetBaseEnd xGetBaseEndInstance;

	xGetBaseEnd::xGetBaseEnd() : mwse::InstructionInterface_t(xGetBaseEndOpcode) {}

	void xGetBaseEnd::loadParameters(mwse::VMExecuteInterface &virtualMachine) {}
	...
	float xGetBaseEnd::execute(mwse::VMExecuteInterface &virtualMachine)
	{
		...
		mwse::Stack::getInstance().pushFloat(macp->attributes[Endurance].base);
