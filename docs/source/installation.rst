...
- The `Morrowind Graphic Extender XE <https://www.nexusmods.com/morrowind/mods/26348/?>`_ (MGE XE) allows MWSE to be loaded. Versions prior to 0.9.10 will not function with MWSE v2.0, and at least 0.10.0 is required for MWSE nightlies.
