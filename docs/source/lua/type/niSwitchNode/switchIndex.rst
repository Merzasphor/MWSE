...
`number`_. The value of the active child index. This index represents the index of the active child in the NiNode child array of the NiSwitchNode. If this index is –1, then no child is active.
