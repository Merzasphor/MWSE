...
`enchantCapacity <tes3book/enchantCapacity.html>`_ (`number`_)
    The object's enchantment capacity.

`enchantment <tes3book/enchantment.html>`_ (`tes3enchantment`_)
    The enchantment used by the object.

`icon <tes3book/icon.html>`_ (`string`_)
    The path to the object's icon.

`id <tes3baseObject/id.html>`_ (`string`_)
    The unique identifier for the object.

`mesh <tes3book/mesh.html>`_ (`string`_)
    The path to the object's mesh.

`modified <tes3baseObject/modified.html>`_ (`boolean`_)
    The modification state of the object since the last save.

`name <tes3book/name.html>`_ (`string`_)
...
`script <tes3book/script.html>`_ (`tes3script`_)
    The script that runs on the object.

`skill <tes3book/skill.html>`_ (`number`_)
...
`text <tes3book/text.html>`_ (`string`_)
    Loads and displays the text of the book.

`type <tes3book/type.html>`_ (`number`_)
    The book type, where 0 is book and 1 is scroll.

`value <tes3book/value.html>`_ (`number`_)
    The value of the object.

`weight <tes3book/weight.html>`_ (`number`_)
