...
An object containing the actual geometry data necessary to render an NiTriShape object..
...
.. toctree::
    ...
    niTriShapeData/compressFlags
    niTriShapeData/dataFlags
    niTriShapeData/dirtyFlags
    niTriShapeData/id
    niTriShapeData/keepFlags
...
.. _`compressFlags`: niTriShapeData/compressFlags.html
.. _`dataFlags`: niTriShapeData/dataFlags.html
.. _`dirtyFlags`: niTriShapeData/dirtyFlags.html
.. _`id`: niTriShapeData/id.html
.. _`keepFlags`: niTriShapeData/keepFlags.html
