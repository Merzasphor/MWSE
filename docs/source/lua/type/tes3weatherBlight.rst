...
`blightDiseaseChance <tes3weatherBlight/blightDiseaseChance.html>`_ (`number`_)
    The weather's blight chance value.

`blightDiseases <tes3weatherBlight/blightDiseases.html>`_ (`table`_)
...
`threshold <tes3weatherBlight/threshold.html>`_ (`number`_)
