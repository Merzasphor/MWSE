...
`mode <niBillboardNode/mode.html>`_ (`number`_)
...
`rotateToCamera <niBillboardNode/rotateToCamera.html>`_ (`method`_)
...
.. toctree::
    ...
    niBillboardNode/rotateToCamera
