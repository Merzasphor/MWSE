...
This type inherits from the following parent types: `tes3weather`_
...
`maxParticles <tes3weatherSnow/maxParticles.html>`_ (`number`_)
    The weather's maximum particles.

`particleEntranceSpeed <tes3weatherSnow/particleEntranceSpeed.html>`_ (`number`_)
    The weather's particle entrance speed.

`particleHeightMax <tes3weatherSnow/particleHeightMax.html>`_ (`number`_)
    The weather's particle maximum height.

`particleHeightMin <tes3weatherSnow/particleHeightMin.html>`_ (`number`_)
    The weather's particle minimum height.

`particleRadius <tes3weatherSnow/particleRadius.html>`_ (`number`_)
...
`threshold <tes3weatherSnow/threshold.html>`_ (`number`_)
