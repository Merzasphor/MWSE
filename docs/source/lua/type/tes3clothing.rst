...
`enchantCapacity <tes3clothing/enchantCapacity.html>`_ (`number`_)
    The object's enchantment capacity.

`enchantment <tes3clothing/enchantment.html>`_ (`tes3enchantment`_)
    The enchantment used by the object.

`icon <tes3clothing/icon.html>`_ (`string`_)
    The path to the object's icon.

`id <tes3baseObject/id.html>`_ (`string`_)
    The unique identifier for the object.

`isLeftPart <tes3clothing/isLeftPart.html>`_ (`boolean`_)
    Determines if the armor is the left part of a pair.

`mesh <tes3clothing/mesh.html>`_ (`string`_)
    The path to the object's mesh.

`modified <tes3baseObject/modified.html>`_ (`boolean`_)
    The modification state of the object since the last save.

`name <tes3clothing/name.html>`_ (`string`_)
...
`parts <tes3clothing/parts.html>`_ (`table`_)
...
`script <tes3clothing/script.html>`_ (`tes3script`_)
    The script that runs on the object.

`slot <tes3clothing/slot.html>`_ (`number`_)
    The slot used by the armor.

`slotName <tes3clothing/slotName.html>`_ (`string`_)
