...
An object that represents a point light source in a scene. Point lights have a specific location in space and a distance attenuation function. Point lights project illumination in all directions from their model space origin. They may be positioned anywhere by changing the translation of the light object.
