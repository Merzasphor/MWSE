...
`part <tes3bodyPart/part.html>`_ (`number`_)
    No description available.

`partType <tes3bodyPart/partType.html>`_ (`number`_)
    No description available.

`persistent <tes3baseObject/persistent.html>`_ (`boolean`_)
    The persistent flag of the object.

`playable <tes3bodyPart/playable.html>`_ (`boolean`_)
...
`raceName <tes3bodyPart/raceName.html>`_ (`string`_)
    The name of the race associated with this body part.

`scale <tes3object/scale.html>`_ (`number`_)
    The object's scale.

`sceneNode <tes3bodyPart/sceneNode.html>`_ (`niNode`_)
...
`vampiric <tes3bodyPart/vampiric.html>`_ (`boolean`_)
