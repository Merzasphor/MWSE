...
`mesh <tes3activator/mesh.html>`_ (`string`_)
    The path to the object's mesh.

`modified <tes3baseObject/modified.html>`_ (`boolean`_)
    The modification state of the object since the last save.

`name <tes3activator/name.html>`_ (`string`_)
...
`script <tes3activator/script.html>`_ (`tes3script`_)
...
`create <tes3activator/create.html>`_ (`function`_)
