...
`boolean`_ Property. Controls if the mobile has movement collision active. When false, the mobile can move through any object, but can still block other mobiles. Actors will still follow pathgrids, ramps and stairs when navigating.
