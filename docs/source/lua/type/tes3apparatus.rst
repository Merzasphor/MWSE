...
`icon <tes3apparatus/icon.html>`_ (`string`_)
    The path to the object's icon.

`id <tes3baseObject/id.html>`_ (`string`_)
    The unique identifier for the object.

`mesh <tes3apparatus/mesh.html>`_ (`string`_)
    The path to the object's mesh.

`modified <tes3baseObject/modified.html>`_ (`boolean`_)
    The modification state of the object since the last save.

`name <tes3apparatus/name.html>`_ (`string`_)
...
`quality <tes3apparatus/quality.html>`_ (`number`_)
...
`script <tes3apparatus/script.html>`_ (`tes3script`_)
...
`type <tes3apparatus/type.html>`_ (`number`_)
    The type of the apparatus.

`value <tes3apparatus/value.html>`_ (`number`_)
    The value of the object.

`weight <tes3apparatus/weight.html>`_ (`number`_)
