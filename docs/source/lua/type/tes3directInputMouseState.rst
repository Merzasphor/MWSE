...
`buttons <tes3directInputMouseState/buttons.html>`_ (`table`_)
    The array-style access to 8 buttons states available on the mouse. Not all may be used.

`x <tes3directInputMouseState/x.html>`_ (`number`_)
    A basic property of the mouse for the X-axis.

`y <tes3directInputMouseState/y.html>`_ (`number`_)
    A basic property of the mouse for the Y-axis.

`z <tes3directInputMouseState/z.html>`_ (`number`_)
