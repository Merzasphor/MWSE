...
`icon <tes3repairTool/icon.html>`_ (`string`_)
    The path to the object's icon.

`id <tes3baseObject/id.html>`_ (`string`_)
    The unique identifier for the object.

`maxCondition <tes3repairTool/maxCondition.html>`_ (`number`_)
    The maximum condition/health of the object.

`mesh <tes3repairTool/mesh.html>`_ (`string`_)
    The path to the object's mesh.

`modified <tes3baseObject/modified.html>`_ (`boolean`_)
    The modification state of the object since the last save.

`name <tes3repairTool/name.html>`_ (`string`_)
...
`quality <tes3repairTool/quality.html>`_ (`number`_)
...
`script <tes3repairTool/script.html>`_ (`tes3script`_)
...
`value <tes3repairTool/value.html>`_ (`number`_)
    The value of the object.

`weight <tes3repairTool/weight.html>`_ (`number`_)
