...
`tes3mobileActor`_Read-only. The mobile actor of the trainer the player is interacting with.

price
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

`number`_The adjusted price of the training.
...
`number`_The ID of the skill to be trained.
