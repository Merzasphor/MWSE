...
`table`_. A table of companions (references) that will travel with the player, or nil if no companions are present.
...
`tes3reference`_. The travel marker that marks the destination.
