...
--- @field object niAmbientLight|niBillboardNode|niCamera|niCollisionSwitch|niDirectionalLight|niDynamicEffect|niLight|niNode|niPointLight|niSpotLight|niSwitchNode|niTriShape *Read-only*. The object of the record.
--- @field parent niAmbientLight|niBillboardNode|niCamera|niCollisionSwitch|niDirectionalLight|niDynamicEffect|niLight|niNode|niPointLight|niSpotLight|niSwitchNode|niTriShape *Read-only*. The parent of the record.
