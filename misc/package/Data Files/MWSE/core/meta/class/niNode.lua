...
--- @field children niAmbientLight[]|niBillboardNode[]|niCamera[]|niCollisionSwitch[]|niDirectionalLight[]|niDynamicEffect[]|niLight[]|niNode[]|niPointLight[]|niSpotLight[]|niSwitchNode[]|niTriShape[] *Read-only*. The children of the node.
...
--- @param child niAmbientLight|niBillboardNode|niCamera|niCollisionSwitch|niDirectionalLight|niDynamicEffect|niLight|niNode|niPointLight|niSpotLight|niSwitchNode|niTriShape No description yet available.
