...
--- @field packages tes3aiPackageActivate[]|tes3aiPackageEscort[]|tes3aiPackageFollow[]|tes3aiPackageTravel[]|tes3aiPackageWander[] *Read-only*. The table with `tes3aiPackage` objects assigned to this mobile actor.
tes3aiPlanner = {}
