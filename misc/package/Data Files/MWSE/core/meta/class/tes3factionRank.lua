...
--- @field attributes table *Read-only*. An array-style table holding the two attribute requirements.
--- @field reputation number The reputation requirement to advance to this rank.
--- @field skills table *Read-only*. An array-style table holding the two skill requirements.
tes3factionRank = {}
