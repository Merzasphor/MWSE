...
--- @field decalCount number *Read-only*. The number of decals currently on the texturing property.
...
--- @param texture niTexture *Optional*. The texture to assign to the new decal.
