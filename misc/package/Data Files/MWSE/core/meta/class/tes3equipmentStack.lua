...
---@field object tes3item The core game object that the stack represents.
---@field variables tes3itemData Variables that are associated with the stack's object, if any.
tes3equipmentStack = {}
