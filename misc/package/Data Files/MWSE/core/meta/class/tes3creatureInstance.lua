...
--- @field aiConfig tes3aiConfig Simplified access to the base creature's AI configuration.
...
--- @field equipment tes3iterator A collection that contains the currently equipped items.
--- @field fatigue number The creature's current fatigue.
--- @field flies boolean Access to the creature's flies flag.
--- @field health number The creature's current health.
--- @field inventory tes3iterator A collection that contains the items in the actor's inventory.
--- @field isAttacked boolean If true, the creature attacked flag is set.
--- @field isEssential boolean If true, the creature essential flag is set.
--- @field isInstance boolean Always returns true.
--- @field isRespawn boolean If true, the creature respawn flag is set.
--- @field level number The base level of the creature.
--- @field magicka number The creature's current magicka.
...
--- @field spells tes3spellList Quick access to the base creature's spell list. It is a tes3spellList, which is a list wrapper with helper functions. The actual list is accessed with .iterator. e.g. for _, spell in pairs(creature.spells.iterator) do print(spell.name) end
...
--- @field weapon tes3weapon The creature's currently equipped weapon.
