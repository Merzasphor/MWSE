...
--- @field worldLandscapeRoot niBillboardNode|niCollisionSwitch|niNode|niSwitchNode One of the core parent scene graph nodes.
--- @field worldObjectRoot niBillboardNode|niCollisionSwitch|niNode|niSwitchNode One of the core parent scene graph nodes.
--- @field worldPickObjectRoot niBillboardNode|niCollisionSwitch|niNode|niSwitchNode One of the core parent scene graph nodes.
tes3dataHandler = {}
