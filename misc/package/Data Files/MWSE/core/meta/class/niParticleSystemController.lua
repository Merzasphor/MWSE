...
--- @field emitterModifiers niAlphaProperty[]|niAmbientLight[]|niBillboardNode[]|niCamera[]|niCollisionSwitch[]|niColorData[]|niDirectionalLight[]|niDynamicEffect[]|niExtraData[]|niFogProperty[]|niGeometryData[]|niGravity[]|niKeyframeController[]|niKeyframeData[]|niLight[]|niLookAtController[]|niMaterialProperty[]|niNode[]|niParticleBomb[]|niParticleCollider[]|niParticleColorModifier[]|niParticleGrowFade[]|niParticleRotation[]|niParticleSystemController[]|niParticles[]|niParticlesData[]|niPixelData[]|niPlanarCollider[]|niPointLight[]|niRotatingParticles[]|niRotatingParticlesData[]|niSkinData[]|niSkinInstance[]|niSourceTexture[]|niSphericalCollider[]|niSpotLight[]|niStencilProperty[]|niStringExtraData[]|niSwitchNode[]|niTexture[]|niTextureEffect[]|niTexturingProperty[]|niTimeController[]|niTriBasedGeometryData[]|niTriShape[]|niTriShapeData[]|niVertexColorProperty[] Modifiers that will influence the particle system by modifying the emmiting object.
