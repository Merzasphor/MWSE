...
--- @field errorCode string|nil The error code of the program, or 0 if there was no error.
--- @field exitCode string|nil The exit code of the program, or nil if the program has not yet finished.
