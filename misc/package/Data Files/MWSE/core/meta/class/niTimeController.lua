...
--- @field target niAlphaProperty|niAmbientLight|niBillboardNode|niCamera|niCollisionSwitch|niDirectionalLight|niFogProperty|niMaterialProperty|niNode|niParticles|niPointLight|niRotatingParticles|niSourceTexture|niSpotLight|niStencilProperty|niSwitchNode|niTexture|niTextureEffect|niTexturingProperty|niTriShape|niVertexColorProperty|niZBufferProperty The scene graph object that this animation controller is to animate.
niTimeController = {}
