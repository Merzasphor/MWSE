...
--- @field castSound string *Optional*. Path to the sound which will be played on casting a spell with this effect. Must be a string no longer than 31 characters long.
--- @field boltSound string *Optional*. Path to the sound which will be played when a spell with this effect is in flight. Must be a string no longer than 31 characters long.
--- @field hitSound string *Optional*. Path to the sound which will be played when a spell with this effect hits something. Must be a string no longer than 31 characters long.
--- @field areaSound string *Optional*. Must be a string no longer than 31 characters long.
