...
--- @field element tesuiElement *Read-only*. The command.
...
--- @field menu tesuiElement *Read-only*. The dialogue object.
--- @field tile tes3uiInventoryTile *Read-only*. The dialogue info object.
