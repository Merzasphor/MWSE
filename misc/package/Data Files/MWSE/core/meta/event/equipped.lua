...
--- @field actor tes3container|tes3containerInstance|tes3creature|tes3creatureInstance|tes3npc|tes3npcInstance The actor that has equipped the item.
...
--- @field mobile tes3mobileActor|tes3mobileCreature|tes3mobileNPC|tes3mobilePlayer The mobile actor that has equipped the item.
--- @field reference tes3reference The reference to the mobile actor that has equipped the item.
