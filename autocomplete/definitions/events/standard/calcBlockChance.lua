return {
	type = "event",
	description = "This event is raised when determining the block chance for an actor. This does not affect ranged or magic attacks and ignores attacks outside of the normal blocking angles, like being attacked from behind.",
	eventData = {
		["attacker"] = {
			type = "tes3reference",
			readOnly = true,
