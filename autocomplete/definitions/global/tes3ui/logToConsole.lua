return {
	...
	arguments = {
		...
		{ name = "isCommand", type = "boolean", optional = true, default = false, description = "Passing `true` will make the text in the console selectable by using up arrow key. If it is a valid command, then pressing enter will call it." },
	},
	examples = {
		["isCommandUse"] = {
