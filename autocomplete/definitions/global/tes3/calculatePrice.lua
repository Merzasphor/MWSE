return {
	...
	arguments = {{
		...
		tableParams = {
			...
			{ name = "skill", type = "number", description = "If `training`, the skill ID passed to the [calcTrainingPrice](https://mwse.github.io/MWSE/events/calcTrainingPrice) event. Maps to value in [`tes3.skill`](https://mwse.github.io/MWSE/references/skills/) table." },
		},
	}},
	returns = {
