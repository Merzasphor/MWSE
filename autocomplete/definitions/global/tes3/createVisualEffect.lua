return {
	...
	arguments = {{
		...
		tableParams = {
			...
			{ name = "lifespan", type = "number", optional = true, description = "The desired lifespan for the VFX. If not provided, the VFX will die of old age." },
			{ name = "scale", type = "number", default = 1.5, description = "The scale used to resize the given VFX. The default value will match the size used by most magical effect logic. This is not used when creating an enchantment-style VFX." },
