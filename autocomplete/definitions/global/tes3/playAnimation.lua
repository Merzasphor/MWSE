...
As a special case, `tes3.playAnimation{reference = ..., group = 0}` returns control to the AI, as the AI knows that is the actor's neutral idle state.]],
	arguments = {{
		...
		tableParams = {
			...
			{ name = "startFlag", type = "number", optional = true, default = "tes3.animationStartFlag.immediate", description = "A flag for starting the group with, using [`tes3.animationStartFlag`](https://mwse.github.io/MWSE/references/animation-start-flags/) constants." },
