return {
	...
	arguments = {{
		...
		tableParams = {
			...
			{ name = "force", type = "boolean", optional = true, default = false, description = "If true, no checks are made to see if the item data should be deleted. It will always be purged." },
			{ name = "ignoreOwnership", type = "boolean", optional = true, default = true, description = "If `force` is false, a check will be made to see if the item data is empty and can be deleted. By default this ignores any ownership data. Setting this to false will override that behavior." },
