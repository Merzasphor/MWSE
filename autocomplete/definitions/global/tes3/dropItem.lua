return {
	...
	arguments = {{
		...
		tableParams = {
			...
			{ name = "matchNoItemData", type = "boolean", optional = true, default = false, description = "If true, matches an item without item data. This can be used when you want to drop an item that isn't equipped (equipped items always have item data)." },
			{ name = "count", type = "number", optional = true, default = 1, description = "The number of items to drop." },
