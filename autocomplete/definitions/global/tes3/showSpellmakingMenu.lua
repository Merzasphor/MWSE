return {
	...
	arguments = {{
		...
		type = "table",
		tableParams = {
			{ name = "serviceActor", type = "tes3mobileActor", optional = true, description = "The actor to use for calculating the service price. If none is provided, an open dialog menu's service actor will be used instead." },
