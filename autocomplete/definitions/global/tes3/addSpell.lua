return {
	...
	arguments = {{
		...
		tableParams = {
			...
			{ name = "updateGUI", type = "boolean", default = true, description = "If true, the GUI will be updated respecting the adding of the spell. This can be useful to disable when batch-adding many spells. The batch should be ended with [`tes3.updateMagicGUI`](https://mwse.github.io/MWSE/apis/tes3/#tes3updatemagicgui) to reflect the changes." },
		},
	}},
	returns = {
