return {
	type = "function",
	description = [[Converts the given value into a proper lpeg pattern.
...
string.]],
	link = "http://www.inf.puc-rio.br/~roberto/lpeg/#op-p",
	arguments = {
		{ name = "value", type = "pattern|string|number|boolean|table|function", description = "The value to convert to a pattern." },
	},
	valuetype = "pattern",
}