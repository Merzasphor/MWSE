return {
	type = "function",
	description = [[Create a match-time capture.
...
Any extra values returned by f become the values produced by the capture. ]],
	link = "http://www.inf.puc-rio.br/~roberto/lpeg/#matchtime",
	arguments = {
		{ name = "p", type = "pattern", description = "The pattern to capture with." },
		{ name = "f", type = "function", description = "The function to call to evaluate matches." },
	},
	valuetype = "pattern",
}