return {
	...
	arguments = {
		{ name = "skillId", type = "number", description = "The index of the skill statistic's value to fetch. Maps to values in [`tes3.skill`](https://mwse.github.io/MWSE/references/skills/) namespace." },
	},
	valuetype = "number",
}