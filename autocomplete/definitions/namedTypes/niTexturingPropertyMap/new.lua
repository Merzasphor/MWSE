return {
	...
	arguments = {{
		...
		tableParams = {
			...
			{ name = "clampMode", type = "number", optional = true, default = "WRAP_S_WRAP_T", description = "The clamp mode to set the map to use." },
			{ name = "filterMode", type = "number", optional = true, default = "TRILERP", description = "The filter mode to set the map to use." },
			{ name = "textCoords", type = "number", optional = true, default = "0", description = "The texture coordinates to set the map to use." },
