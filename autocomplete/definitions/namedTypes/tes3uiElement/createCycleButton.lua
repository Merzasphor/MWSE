return {
	type = "method",
	description = [[Creates a clickable button, whose text changes linerally through options as it is clicked. Register the `valueChanged` event for when the option is cycled or changed via script.
